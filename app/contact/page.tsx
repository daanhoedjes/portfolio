        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex flex-col gap-8 flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 mt-1">
              {/* GITHUB */}
              <a href="https://github.com" target="_blank" rel="noreferrer" className="bg-[#151517] rounded-3xl p-8 flex flex-col items-center justify-center gap-5 border border-white/[0.03] hover:border-teal-500/20 transition-colors group">
              ...
              {/* LINKEDIN */}
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="bg-[#151517] rounded-3xl p-8 flex flex-col items-center justify-center gap-5 border border-white/[0.03] hover:border-teal-500/20 transition-colors group">
                <div className="text-white group-hover:text-teal-400 transition-colors">
